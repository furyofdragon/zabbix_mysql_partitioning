...
BEGIN 
CALL partition_maintenance(SCHEMA_NAME, 'history', 7, 10, 10);

CALL partition_maintenance(SCHEMA_NAME, 'history_log', 7, 10, 10);

  CALL partition_maintenance(SCHEMA_NAME, 'history_str', 7, 10, 10);

  CALL partition_maintenance(SCHEMA_NAME, 'history_text', 7, 10, 10);

  CALL partition_maintenance(SCHEMA_NAME, 'history_uint', 7, 10, 10);
...
-- Dump completed on 2019-08-30 10:40:18
